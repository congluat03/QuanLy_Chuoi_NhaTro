...
urlpatterns = [
    ...
    path('thanh-toan-dat-phong/<int:ma_dat_phong>/', user_views.thanh_toan_dat_phong, name='thanh_toan_dat_phong'),
    path('xac-nhan-dat-phong/<int:ma_dat_phong>/', user_views.xac_nhan_dat_phong, name='xac_nhan_dat_phong'),
    
    # Phòng đã đặt
    path('phong-da-dat/', user_views.phong_da_dat, name='phong_da_dat'),
